...
class Ad extends Model
{
    ...
    {
        $publishStatusSqlStatement = 'CASE WHEN p2p_ads.complete_step = 3 THEN (CASE WHEN p2p_ads.type = 1 THEN 1 ELSE (CASE WHEN wallets.balance >= p2p_ads.minimum_amount THEN 1 ELSE 0 END) END ) ELSE 0 END as publish_status';
    ...
    public function pricinTypeBadge(): Attribute
    {
        return new Attribute(function () {
