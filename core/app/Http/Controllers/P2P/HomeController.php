...
class HomeController extends Controller
{
    ...
    public function advertiser($id)
    {
        ...
        $feeback    = userFeedabck($advertiser->id);
        ...
        $paymentMethods = PaymentMethod::select('supported_currency', 'id', 'slug', 'name', 'branding_color')->active()->get();
        return view($this->activeTemplate . 'p2p.advertiser_details', compact('pageTitle', 'advertiser', 'feeback', 'widget', 'ads', 'paymentMethods'));
    }
}
