				...
				<div class="col-xxl-3 col-sm-6">
					<div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
						...
						<a class="widget-two__btn"
							href="{{ route('admin.order.history') }}?user_id={{ $user->id }}">@lang('View All')</a>
					</div>
				</div>
				<div class="col-xxl-3 col-sm-6">
					<div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
						...
						<a class="widget-two__btn"
							href="{{ route('admin.trade.history') }}?trader_id={{ $user->id }}">@lang('View All')</a>
					</div>
				</div>
				<div class="col-xxl-3 col-sm-6">
			...
			<div class="d-flex mt-4 flex-wrap gap-3">
				...
				<div class="flex-fill">
					<a class="btn btn--success btn--gradi btn--shadow w-100 btn-lg"
						href="{{ route('admin.users.trades', ['username' => $user->username]) }}" target="_blank">
						<i class="las la-file-invoice-dollar"></i>@lang('Binaries')
					</a>
				</div>
				...
				@if ($user->kyc_data)
					<div class="flex-fill">
						<a class="btn btn--dark btn--shadow w-100 btn-lg" href="{{ route('admin.users.kyc.details', $user->id) }}"
							target="_blank">
