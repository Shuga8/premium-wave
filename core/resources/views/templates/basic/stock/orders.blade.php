...
@endphp
    ...
    <div class="trading-left trading-list-empty">
        ...
        <div class="trading-left__top">
            ...
            <div>
                <ul class="nav nav-pills mb-0 custom--tab" style="color:white;">
                    <li class="nav-item change-order-type ps-1 pe-1" data-order-type="all" style="color:white;">
                        <button type="button" class="nav-link active">
                            @lang('All')
                        </button>
                    </li>
                    <li class="nav-item change-order-type ps-1 pe-1" data-order-type="sell" style="color:white;">
                        <button type="button" class="nav-link">
                            @lang('Sell')
                        </button>
                    </li>
                    <li class="nav-item change-order-type ps-1 pe-1" data-order-type="buy" style="color:white;">
                        <button type="button" class="nav-link">
                            @lang('Buy')
                        </button>
                    </li>
