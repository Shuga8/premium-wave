...
<div
	class="trading-left trading-list-empty @if ($meta->screen == 'big') d-xl-block d-none @elseif($meta->screen == 'medium')  two @endif">
	@if ($meta->screen == 'big')
	...
	<div class="trading-left__top">
		...
		<div>
			<ul class="nav nav-pills custom--tab mb-0">
				<li class="nav-item change-order-type pe-1 ps-1" data-order-type="all">
		...
		<div class="tab-pane fade show active d-flex d-xl-block flex-wrap gap-2">
			<div class="trading-left__buy flex-fill">
				<div class="trading-left__header flex-between sell-side-order-list-header">
					<span class="price__title">@lang('Price')({{ @$pair }})</span>
