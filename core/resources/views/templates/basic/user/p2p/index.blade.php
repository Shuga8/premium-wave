                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="dashboard-card__content">
                                <a href="{{ route('user.p2p.trade.list','running') }}" class="dashboard-card__coin-name mb-0 ">
                                    @lang('Runing Trade') </a>
                                <h6 class="dashboard-card__coin-title text-end"> {{ getAmount($widget['runing_trade']) }}
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-card">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="dashboard-card__content">
                                ...
                                <h6 class="dashboard-card__coin-title text-end"> {{ getAmount(@$widget['feeback']->negative) }}
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-card">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="dashboard-card__content">
                                ...
                                <h6 class="dashboard-card__coin-title text-end"> {{ getAmount(@$widget['feeback']->positive) }}
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-card">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="dashboard-card__content">
                                ...
                                <h6 class="dashboard-card__coin-title text-end"> {{ getAmount(@$widget['feeback']->total) }}
                                </h6>
                            </div>
                        </div>
                    </div>
