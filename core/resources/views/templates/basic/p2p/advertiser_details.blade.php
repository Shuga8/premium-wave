        ...
        <div class="container">
            <div class="publisher">
                    ...
                    <div class="publisher-order-details text-center">
                        ...
                        <div class="order-reviews d-flex flex-column flex-wrap">
                            <div class="order-reviews-left">
                                <p>{{ @$feeback->positive_percentage }}%</p>
                            </div>
                            <ul class="order-reviews-right">
                                <li class="items">@lang('Positive') <span class="positive">{{ $feeback->positive }}</span>
                                </li>
                                <li class="items">@lang('Negative') <span class="negative">{{ $feeback->negative }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="publisher-bottom">
                    ...
                    <div class="publisher-card">
                        <p class="publisher-card__title">@lang('Reporteed Trades')</span>
                        </p>
                        <h4 class="publisher-card__times">
