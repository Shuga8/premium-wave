			...
			<div class="offcanvas-body">
				@auth
					<form action="{{ route('user.deposit.insert') }}" method="post">
						@csrf
						<input class="deposit-currency-symbol" name="currency" type="hidden">
						<input name="wallet_type" type="hidden" value="spot">
						<div class="form-group">
							<label class="form-label">@lang('Amount')</label>
							<div class="input-group">
								<input class="form--control form-control" name="amount" type="number" step="any" required>
					...
					<div class="empty-gateway p-5 text-center">
						<img src="{{ asset('assets/images/extra_images/no_money.png') }}" alt="">
						<span class="fs-14 mt-3">
