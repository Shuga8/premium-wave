...
<div class="dashboard-header">
	<div class="dashboard-header__inner">
		<div class="dashboard-header__left">
			<div class="copy-link">
				<input class="copyText" type="text" value="{{ route('home') }}?reference={{ $user->username }}" readonly>
		...
		<div class="dashboard-header__right">
			<a class="btn btn--base btn--sm trade-btn outline" href="{{ route('wave') }}" target="_blank">
