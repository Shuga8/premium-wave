...
Route::namespace('User\P2P')->group(function () {
    ...
    Route::get('/feeback/list', "HomeController@feedbackList")->name('feedback.list');
    ...
    Route::name('trade.')->prefix('trade')->group(function () {
        Route::controller("TradeController")->group(function () {
            ...
            Route::post('/delete/feeback/{id}', 'feebackDelete')->name('feeback.delete');
            Route::post('/feeback/{id}', 'feeback')->name('feeback');
