...
Route::middleware('admin')->group(function () {
    ...
    Route::prefix('commodity/setting')->name('commodity.setting.')->controller("CommoditySettingController")->group(function () {
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        // trading view chart
        Route::get('chart/setting', 'chargeSetting')->name('setting.chart');
